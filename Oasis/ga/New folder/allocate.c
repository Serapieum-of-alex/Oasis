...
def allocate_memory_pop(population *pop, int size, Global global)
...
def allocate_memory_ind (individual *ind, Global global)
...
def deallocate_memory_pop (population *pop, int size, Global global)
...
def deallocate_memory_ind (individual *ind, Global global)
